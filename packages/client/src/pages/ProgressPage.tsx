 ...
 *
 * ProgressDashboard remains untouched — it still powers the landing-dashboard
 * (home/) variant and the ProgressReveal wrapper's inner content.
 *
 * ProgressAuditPage (the new radial+cards surface) lives below and is what the
 * ProgressReveal wrapper now reveals, replacing ProgressDashboard there too.
 */
...
// ─── Context wiring (identical to ProgressBars / RequirementProgress) ─────────
...
// ─── ProgressAuditPage (the FR-4 radial + cards page) ───────────────────────
