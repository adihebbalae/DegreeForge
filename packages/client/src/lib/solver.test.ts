...
const mockGraphData: PrereqGraphData = {
  nodes: {
    ...
    'M 408D':   { title: 'Calc II', category: 'math',     flags: [] },
    'M 427J':   { title: 'Diff Eq', category: 'math',     flags: [] },
    'M 340L':   { title: 'Linear Algebra', category: 'math',     flags: [] },
    'M 325K':   { title: 'Discrete Math', category: 'math',     flags: [] },
    'ECE 302':  { title: 'Intro EE', category: 'ece_core', flags: [] },
    'ECE 306':  { title: 'Intro Computing', category: 'ece_core', flags: [] },
    'ECE 312':  { title: 'Software I', category: 'ece_core', flags: [] },
    'ECE 319K': { title: 'Embedded Systems', category: 'ece_core', flags: [] },
    'ECE 411':  { title: 'Circuit Theory', category: 'ece_core', flags: [] },
    'ECE 313':  { title: 'Linear Systems', category: 'ece_core', flags: [] },
    'ECE 316':  { title: 'Digital Logic', category: 'ece_upper', flags: [] },
    'ECE 460N': { title: 'Computer Arch', category: 'ece_upper', flags: [] },
    'ECE 360C': { title: 'Algorithms', category: 'ece_upper', flags: [] },
    'ECE 445L': { title: 'Embedded Lab', category: 'ece_upper', flags: [] },
    'ECE 351K': { title: 'Probability', category: 'ece_core', flags: [] },
    'ECE 333T': { title: 'Eng Communication', category: 'ece_core', flags: [] },
    'ECE 325':  { title: 'EM Engineering', category: 'ece_upper', flags: [] },
    'ECE 339':  { title: 'Solid-State Devices', category: 'ece_upper', flags: [] },
    'ECE 422C': { title: 'Software II', category: 'ece_upper', flags: [] },
  },
  edges: [
